    ...
    <div class="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold text-gray-900 mb-2">Baking Bad 3.3L</h3>
            <p class="text-gray-600 mb-4">Les Baking Bad 3.3L apportent une touche d’humour à votre cuisine avec un design amusant et des normes de sécurité strictes. Non rechargeable, non médical, et non destiné à l’inhalation.
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold text-gray-900 mb-2">Miami Magic 3.3L</h3>
            <p class="text-gray-600 mb-4">       
                   <p class="text-gray-600 mb-4">Les Miami Magic 3.3L apportent une touche d’humour à votre cuisine avec un design amusant et des normes de sécurité strictes. Non rechargeable, non médical, et non destiné à l’inhalation.
            </p>
            <button (click)="openOrderForm('Tank Miami')" 
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 flex items-center justify-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
          ...
          <div class="p-6">
            <h3 class="text-xl font-bold text-gray-900 mb-2">Miami Magic 4.5L</h3>
            <p class="text-gray-600 mb-4">Les Miami Magic 4.5L apportent une touche d’humour à votre cuisine avec un design amusant et des normes de sécurité strictes. Non rechargeable, non médical, et non destiné à l’inhalation.
            </p>            <button (click)="openOrderForm('Tank Miami')" 
                    class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 flex items-center justify-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"/>
              </svg>
...
export class UltraTanksComponent {
  orderForm: FormGroup;
  showOrderForm = false;
